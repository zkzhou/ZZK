...
public class ImmersiveStatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.immersive_status_bar_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.immersive_status_bar_translucent_view;
